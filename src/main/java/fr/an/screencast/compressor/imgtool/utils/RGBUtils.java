...
public final class RGBUtils {
    ...
    public static void intRGBsToGzipBytes(int[] imgData, ByteBuffer out) {
        ByteBufferOutputStream bOut = new ByteBufferOutputStream(out);
        intRGBsToGzipBytes(imgData, bOut);
    }
